    ...
    <>
      ...
      <div className="table">
        ...
        {loading
          ...
          : filtered.map((r) => (
              // T15 P2-2 fix: link directly to the /app/ prefixed
              // dashboard route. /resources/:id still resolves but only
              // via the LegacyResourceRedirect → <Navigate replace>
              // double-hop, which produces a render flash + a confusing
              // browser-back entry. The legacy unprefixed path is for
              // external/bookmarked links only; internal rows must skip
              // the redirect.
              <Link
